...
namespace TestProject1
{
    ...
    public class TC26 : BaseWebAiiTest
    {
        ...
        public void TC26_CodedStep()
        {
            ...
            {
        HtmlAnchor button = myList[i].Cells[11].Find.ByAttributes<HtmlAnchor>("class=btn btn-info btn-sm edit");

        if (button != null)
        {
            Log.WriteLine("Có button trong cell 11 của hàng " + i);
        }
        else
        {
            Log.WriteLine("Không có button trong cell 11 của hàng " + i);
        }
