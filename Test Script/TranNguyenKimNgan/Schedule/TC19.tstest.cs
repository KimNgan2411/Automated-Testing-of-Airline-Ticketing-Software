...
namespace TestProject1
{
    ...
    public class TC19 : BaseWebAiiTest
    {
...
public void TC19_CodedStep()
{
    ...
    {
        Log.WriteLine(myList[i].Cells[8].InnerText.ToString());
        string cellValue = myList[i].Cells[8].InnerText.Trim();
