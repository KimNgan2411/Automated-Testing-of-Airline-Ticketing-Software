...
namespace TestProject1
{
    ...
    public class TC_01 : BaseWebAiiTest
    {
        ...
        public void TC_01CodedStep()
        {
                string myPath = "E:\\Report.xlsx";
                int rowIndex = 4; // Giả sử vị trí dòng là 2
                int columnIndex = 9; // Giả sử vị trí cột là 1
                string result = "PASS"; // Giá trị cần ghi vào cell
                
                ExcelWriter excelWriter = new ExcelWriter();
                excelWriter.WriteToExcel(myPath, rowIndex, columnIndex, result);            
        }
    
        [CodedStep(@"New Coded Step")]
        public void TC01_CodedStep()
        {
                string myPath = "E:\\Report.xlsx";
                int rowIndex = 4; // Giả sử vị trí dòng là 2
                int columnIndex = 9; // Giả sử vị trí cột là 1
