...
namespace TestProject1
{
    ...
    public class TC03 : BaseWebAiiTest
    {
        ...
        public void TC03_CodedStep()
        {
            ...
            for (int i=2; i<myList.Count; i++)
            {
                ...
                bool isSortedAscending  = IsSortedAscending(cellValues);
                if (isSortedAscending)
                    {
                        Log.WriteLine("Các giá trị đã được sắp xếp theo thứ tự tăng dần.");
                    }
                else
                    {
                        Log.WriteLine("Các giá trị không được sắp xếp theo thứ tự tăng dần.");
                    }

        }
        private bool IsSortedAscending(List<string> values)
        {
