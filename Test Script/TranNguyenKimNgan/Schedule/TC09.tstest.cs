...
namespace TestProject1
{
    ...
    public class TC09 : BaseWebAiiTest
    {
    ...
    bool isSortedAscendingByDate = IsSortedAscendingByDate(dateValues);
    if (isSortedAscendingByDate)
    {
        Log.WriteLine("Các giá trị đã được sắp xếp theo thứ tự thời gian tăng dần.");
    }
    else
    {
        Log.WriteLine("Các giá trị không được sắp xếp theo thứ tự thời gian tăng dần.");
    }
}

private bool IsSortedAscendingByDate(List<DateTime> values)
{
