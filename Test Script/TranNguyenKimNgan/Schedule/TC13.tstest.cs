...
namespace TestProject1
{
    ...
    public class TC13 : BaseWebAiiTest
    {
        ...
        public void TC13_CodedStep()
        {
            ...
            {
                    string cellValue = myList[i].Cells[5].InnerText.Trim();
                    cellValues.Add(cellValue); 
            }
    bool isSortedDescending = IsSortedDescending(cellValues);
    if (isSortedDescending)
    {
        Log.WriteLine("Các giá trị đã được sắp xếp theo thứ tự giảm dần.");
    }
    else
    {
        Log.WriteLine("Các giá trị không được sắp xếp theo thứ tự giảm dần.");
    }
}

private bool IsSortedDescending(List<string> values)
{
