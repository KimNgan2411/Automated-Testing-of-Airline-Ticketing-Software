...
namespace TestProject1
{
    ...
    public class TC17 : BaseWebAiiTest
    {
...
public void TC17_CodedStep()
{
    ...
    {
        Log.WriteLine(myList[i].Cells[7].InnerText.ToString());
        string cellValue = myList[i].Cells[7].InnerText.Trim();
